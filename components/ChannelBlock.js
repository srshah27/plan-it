        ...
        tasks.map((task, i) => (
          ...
          <div key={i} className='dropdown-selection justify-between' >
            <div className='flex'>
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill={task.Priority == 0 ? "green" : (task.Priority == 1 ? "grey" : task.Priority == 2 ? "yellow" : (task.Priority == 3 ? "red" : "blue"))} className="bi bi-flag-fill" viewBox="0 0 16 16">
