      ...
      </div>
      {
        ...
        tasks.map((task, i) => (
          ...
          <div key={i} className='dropdown-selection'>
            <FiCheckSquare size='18' className='text-gray-400 mr-2' />
            {/* <i class="bi bi-flag-fill caret-green-900"></i> */}
            <h5 className='dropdown-selection-text'>{task.Title}</h5>
            ...
            <h5 className='dropdown-selection-text'>{task.Duration} Min</h5>
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill={task.Priority == 0 ? "green" : (task.Priority == 1 ? "grey" : task.Priority == 2 ? "yellow" : (task.Priority == 3 ? "red" : "blue"))} class="bi bi-flag-fill" viewBox="0 0 16 16">
